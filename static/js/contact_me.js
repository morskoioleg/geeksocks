            ...
            $.ajax({
                ...
                error: function() {
                    ...
                    $('#success > .alert-danger').html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;")
                        .append("</button>");
                    $('#success > .alert-danger').append("<strong>Извините " + firstName + ", сообщение не отправлено. Позвоните нам на <a href='tel:+79036665775'>+79036665775</a> или напишите на <a href='mailto:mail@geeksocks.ru'>mail@geeksocks.ru</a>");
            ...
            $.ajax({
                ...
                error: function() {
                    ...
                    $('#success_order > .alert-danger').html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;")
                        .append("</button>");
                    $('#success_order > .alert-danger').append("<strong>Извините " + firstName + ", сообщение не отправлено. Позвоните нам на <a href='tel:+79036665775'>+79036665775</a> или напишите на <a href='mailto:mail@geeksocks.ru'>mail@geeksocks.ru</a>");
